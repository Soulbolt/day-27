...
# Label class
my_label = Label(text="I Am a Label", font=("Arial", 18, "normal"))
# need a label component to display this customer label text which is down below
my_label.grid(column=0, row=0)  # add side=left/bottom/top/right to the component to change position of the label
...
text_input.grid(column=4, row=4)
button_clicked()
"""DEMO OF DIFFERENT WIDGETS BELOW"""
